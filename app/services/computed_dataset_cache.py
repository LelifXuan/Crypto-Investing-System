...
class ComputedDatasetCacheService:
    ...
    def _build_indicator_series(self, candles: list, indicator_group: str) -> dict:
        ...
        return {
            ...
            "vwap_short": _series_to_json(vwap_50),
            "vwap_long": _series_to_json(vwap_100),
            "price_vs_vwap_short_pct": _series_to_json(_spread_pct(closes, vwap_50)),
            "price_vs_vwap_long_pct": _series_to_json(_spread_pct(closes, vwap_100)),
            "vwap_spread_pct": _series_to_json(_spread_pct(vwap_50, vwap_100)),
            "vwap_slope_10": _series_to_json(_value_slope_pct(vwap_50, 10)),
            "vwap_slope_short_10": _series_to_json(_value_slope_pct(vwap_50, 10)),
            "vwap_slope_long_10": _series_to_json(_value_slope_pct(vwap_100, 10)),
