...
Restored 2026-07-23 after the file was deleted by the project restructure
(commit e2f7784). The corresponding test in
tests/test_user_facing_text_audit.py shells out to this script and asserts
it returns non-zero on a fixture containing forbidden text.
"""
